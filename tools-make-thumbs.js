...
global.MV=MV;
var W=300,H=96,BG='#F6F4EE',INK='#16191C',CRIM='#841617',TEAL='#0B7285',GREY='#9AA3AA';
...
(function(){
  ...
  s+=line(W/2,8,W/2,H-8,GREY,1,'3 3');
  T['03']=s+'</svg>';
})();
...
(function(){
  ...
  for(var i=0;i<6;i++){var x=24+i*44,h=v[i]/3.4*70;
    s+=rect(x,H-16-h,26,h,i<3?CRIM:GREY,i<3?0.9:0.4);}
...
(function(){
  ...
  [[0,GREY],[90,GREY]].forEach(function(q){var a=q[0]*Math.PI/180;
...
(function(){
  ...
  s+=line(W/2,H/2-46,W/2,H/2+46,GREY,1.4,'4 3');
  s+=line(W/2-46,H/2,W/2+46,H/2,GREY,1.4,'4 3');
  T['08']=s+'</svg>';
})();
...
(function(){
  ...
  for(var k=0;k<3;k++){var x=18+k*96;
    s+='<rect x="'+x+'" y="14" width="84" height="68" fill="none" stroke="'+GREY+'" stroke-width="1"/>';
